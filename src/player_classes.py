...
class Limb(entity_classes.DamagableSprite):
    def setup(self, body_sprite, window, modifier, id, height_mod, type, hp, defense):
        self.textures = [arcade.load_texture(r"assets\stick man limb half.png"), arcade.load_texture(r"assets\stick man bottom leg half.png"), arcade.load_texture(r"assets\stick man bottom leg half.png", flipped_horizontally=True), arcade.load_texture(r"assets\stick man top arm half.png")]
        self.set_texture(0)
        ...
        self.outline.textures = [arcade.load_texture(r"assets\stick man limb half outline.png"), arcade.load_texture(r"assets\stick man bottom leg half outline.png"), arcade.load_texture(r"assets\stick man bottom leg half outline.png", flipped_horizontally=True), arcade.load_texture(r"assets\stick man top arm half outline.png")]
...
class Head(entity_classes.DamagableSprite):
    def setup(self, body_sprite, window, hp, defense):
        self.textures = [arcade.load_texture(r"assets\stick man head.png", mirrored=True), arcade.load_texture(r"assets\stick man head.png"), arcade.load_texture(r"assets\stick man head dead.png")]
        self.set_texture(1)
        self.base_scale = PLAYER_SCALE
        self.scale = self.base_scale
...
class Torso(entity_classes.DamagableSprite):
    def setup(self, body_sprite, window, hp, defense):
        self.textures = [arcade.load_texture(r"assets\stick man torso.png")]
        self.set_texture(0)
        self.base_scale = PLAYER_SCALE
        self.scale = self.base_scale
